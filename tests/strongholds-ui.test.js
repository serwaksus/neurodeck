...
test('header: «Побег» → «Твердыни», счётчик 0/20, кэш v58 единообразно', () => {
    ...
    assert.deepEqual([...new Set(vs)], ['58'], 'все ?v= = 52');
    assert.ok(html.includes('js/stronghold-model.js?v=58'), 'модель подключена до app.js');
