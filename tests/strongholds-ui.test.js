...
test('header: «Побег» → «Твердыни», счётчик 0/20, кэш v73 единообразно', () => {
    ...
    assert.deepEqual([...new Set(vs)], ['73'], 'все ?v= = 70');
    assert.ok(html.includes('js/stronghold-model.js?v=73'), 'модель подключена до app.js');
