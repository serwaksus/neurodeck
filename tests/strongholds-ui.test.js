...
test('header: «Побег» → «Твердыни», счётчик 0/20, кэш v67 единообразно', () => {
    ...
    assert.deepEqual([...new Set(vs)], ['67'], 'все ?v= = 67');
    assert.ok(html.includes('js/stronghold-model.js?v=67'), 'модель подключена до app.js');
