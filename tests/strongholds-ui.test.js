...
test('header: «Побег» → «Твердыни», счётчик 0/20, кэш v68 единообразно', () => {
    ...
    assert.deepEqual([...new Set(vs)], ['68'], 'все ?v= = 68');
    assert.ok(html.includes('js/stronghold-model.js?v=68'), 'модель подключена до app.js');
