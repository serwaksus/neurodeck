...
test('header: «Побег» → «Твердыни», счётчик 0/20, кэш v66 единообразно', () => {
    ...
    assert.deepEqual([...new Set(vs)], ['66'], 'все ?v= = 66');
    assert.ok(html.includes('js/stronghold-model.js?v=66'), 'модель подключена до app.js');
