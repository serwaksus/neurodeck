...
test('header: «Побег» → «Твердыни», счётчик 0/20, кэш v69 единообразно', () => {
    ...
    assert.deepEqual([...new Set(vs)], ['69'], 'все ?v= = 69');
    assert.ok(html.includes('js/stronghold-model.js?v=69'), 'модель подключена до app.js');
