...
test('header: «Побег» → «Твердыни», счётчик 0/20, кэш v72 единообразно', () => {
    ...
    assert.deepEqual([...new Set(vs)], ['72'], 'все ?v= = 70');
    assert.ok(html.includes('js/stronghold-model.js?v=72'), 'модель подключена до app.js');
