...
test('header: «Побег» → «Твердыни», счётчик 0/20, кэш v57 единообразно', () => {
    ...
    assert.deepEqual([...new Set(vs)], ['57'], 'все ?v= = 52');
    assert.ok(html.includes('js/stronghold-model.js?v=57'), 'модель подключена до app.js');
