...
test('header: «Побег» → «Твердыни», счётчик 0/20, кэш v55 единообразно', () => {
    ...
    assert.deepEqual([...new Set(vs)], ['55'], 'все ?v= = 52');
    assert.ok(html.includes('js/stronghold-model.js?v=55'), 'модель подключена до app.js');
