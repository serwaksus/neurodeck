...
test('header: «Побег» → «Твердыни», счётчик 0/20, кэш v64 единообразно', () => {
    ...
    assert.deepEqual([...new Set(vs)], ['64'], 'все ?v= = 64');
    assert.ok(html.includes('js/stronghold-model.js?v=64'), 'модель подключена до app.js');
