...
test('header: «Побег» → «Твердыни», счётчик 0/20, кэш v56 единообразно', () => {
    ...
    assert.deepEqual([...new Set(vs)], ['56'], 'все ?v= = 52');
    assert.ok(html.includes('js/stronghold-model.js?v=56'), 'модель подключена до app.js');
