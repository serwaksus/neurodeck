...
test('header: «Побег» → «Твердыни», счётчик 0/20, кэш v65 единообразно', () => {
    ...
    assert.deepEqual([...new Set(vs)], ['65'], 'все ?v= = 65');
    assert.ok(html.includes('js/stronghold-model.js?v=65'), 'модель подключена до app.js');
