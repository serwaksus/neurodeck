...
test('header: «Побег» → «Твердыни», счётчик 0/20, кэш v59 единообразно', () => {
    ...
    assert.deepEqual([...new Set(vs)], ['59'], 'все ?v= = 52');
    assert.ok(html.includes('js/stronghold-model.js?v=59'), 'модель подключена до app.js');
