...
test('header: «Побег» → «Твердыни», счётчик 0/20, кэш v70 единообразно', () => {
    ...
    assert.deepEqual([...new Set(vs)], ['70'], 'все ?v= = 70');
    assert.ok(html.includes('js/stronghold-model.js?v=70'), 'модель подключена до app.js');
