...
test('header: «Побег» → «Твердыни», счётчик 0/20, кэш v71 единообразно', () => {
    ...
    assert.deepEqual([...new Set(vs)], ['71'], 'все ?v= = 70');
    assert.ok(html.includes('js/stronghold-model.js?v=71'), 'модель подключена до app.js');
